package dev.zico.weposit.security;
...
public class DemoSecurityConfig {
    ...
    public UserDetailsManager userDetailsManager(DataSource dataSource) {
        //return new JdbcUserDetailsManager(dataSource); //for inbuilt default table names authorities and users
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        //disable cross site scripting for stateless apis
